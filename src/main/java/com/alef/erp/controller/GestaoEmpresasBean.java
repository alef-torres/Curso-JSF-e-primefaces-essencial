...
import com.alef.erp.repository.RamoAtividades;
import com.alef.erp.service.CadastroEmpresaService;
import com.alef.erp.util.FacesMessages;
...
public class GestaoEmpresasBean implements Serializable {
	...
	public void prepararEdicao() {
		ramoAtividadeConverter = (Converter) new RamoAtividadeConverter(Arrays.asList(empresa.getRamoAtividade()));
	}
	...
	public List<RamoAtividade> completarRamoAtividade(String termo) {
		...
		ramoAtividadeConverter = (Converter) new RamoAtividadeConverter(listaRamoAtividades);
